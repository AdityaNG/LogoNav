...
- 🎯 Entry points to execute your program using `python -m <logonav>` or `$ logonav` with basic CLI argument parsing.
...
Awesome logonav created by AdityaNG
...
from logonav import base_function
